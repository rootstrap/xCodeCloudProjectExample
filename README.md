[![Build Status](https://img.shields.io/travis/rootstrap/RSXcodeCloudExample/master.svg)](https://travis-ci.org/rootstrap/RSXcodeCloudExample)
...
- [**feature/mvvm+rxswift**](https://github.com/rootstrap/RSXcodeCloudExample/tree/feature/mvvm%2Brxswift) in case you want to work with **RxSwift** and **MVVM**.
- [**feature/moya_integration**](https://github.com/rootstrap/RSXcodeCloudExample/tree/feature/moya_integration) manage routes and HTTP resources with Moya and Alamofire.
...
Another alternative for managing sensitive files whithin the repo using Git-Secret can be found in the [**feature/git-secret**](https://github.com/rootstrap/RSXcodeCloudExample/tree/feature/jenkins) branch 
...
Alternatively you can merge branch [**feature/jenkins**](https://github.com/rootstrap/RSXcodeCloudExample/tree/feature/jenkins) for some equivalent CICD boilerplate with **Jenkins**.
...
**iOS Base** is maintained by [Rootstrap](http://www.rootstrap.com) with the help of our [contributors](https://github.com/rootstrap/RSXcodeCloudExample/contributors).
